...
class TeleopTank final
{
public:
  TeleopTank()
  {
    nh_ = rclcpp::Node::make_shared("teleop_tank");
    ...
    rotate_absolute_client_ = rclcpp_action::create_client<turtlesim::action::RotateAbsolute>(nh_, "bot1/rotate_absolute");
  }
  ...
  int keyLoop()
  {
    ...
    std::thread{std::bind(&TeleopTank::spin, this)}.detach();
