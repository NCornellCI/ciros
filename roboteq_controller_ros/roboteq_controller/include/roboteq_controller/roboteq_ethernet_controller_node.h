...
class EtherRoboteqDriver : public rclcpp::Node
{
public:
	explicit EtherRoboteqDriver(const rclcpp::NodeOptions &options = rclcpp::NodeOptions());


private:

	std::string 	ethernet_port_;

	// Pub & Sub
	rclcpp::Publisher<std_msgs::msg::String>::SharedPtr 			pub_test_;
	rclcpp::Subscription<geometry_msgs::msg::Twist>::SharedPtr 		cmd_vel_sub_;
	rclcpp::Publisher<std_msgs::msg::String>::SharedPtr 		ethernet_read_pub_;
